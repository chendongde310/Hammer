 ...
 */
package com.synews.hammer.base.delegate;
...
import com.synews.hammer.base.BaseApplication;
import com.synews.hammer.di.component.AppComponent;
import com.synews.hammer.di.component.DaggerAppComponent;
import com.synews.hammer.di.module.AppConfigModule;
import com.synews.hammer.integration.ConfigModule;
import com.synews.hammer.integration.ManifestParser;
...
public class AppDelegate implements App, AppLifecycles {
     ...
     *
     * @see HammerUtils#getAppComponentFromContext(Context) 可直接获取 {@link AppComponent}
     * @return AppComponent
     */
    @NonNull
    @Override
