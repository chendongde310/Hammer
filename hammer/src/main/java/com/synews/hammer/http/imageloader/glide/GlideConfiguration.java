 ...
 */
package com.synews.hammer.http.imageloader.glide;
...
import com.synews.hammer.http.OkHttpUrlLoader;
...
public class GlideConfiguration extends AppGlideModule {
    ...
    public void applyOptions(Context context, GlideBuilder builder) {
        AppComponent appComponent = HammerUtils.getAppComponentFromContext(context);
