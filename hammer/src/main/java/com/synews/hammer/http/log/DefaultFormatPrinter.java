 ...
 */
package com.synews.hammer.http.log;

import android.text.TextUtils;

import com.synews.hammer.utils.CharacterHandler;
...
public class DefaultFormatPrinter implements FormatPrinter {
    ...
    private static final String[] OMITTED_RESPONSE = {LINE_SEPARATOR, "省略响应体"};
    private static final String[] OMITTED_REQUEST = {LINE_SEPARATOR, "省略请求体"};
